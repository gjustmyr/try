...
| Discounts and promo codes | **No** — no promo/coupon/discount system exists | ❌ |
| Tax and pricing data | **No** — no tax calculation; only subtotal + shippingFee = total | ❌ |
...
2. Tax calculation — **none**
3. Promo codes / discounts — **none**

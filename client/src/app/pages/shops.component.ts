...
@Component({
      ...
      <section class="shops-section">
        <div class="container">
          <div class="shops-header">
            <span class="shop-count">{{ shops.length }} {{ shops.length === 1 ? 'Store' : 'Stores' }}</span>
          </div>
  ...
  styles: [`
    ...
    .shops-hero h1 { font-size: 32px; font-weight: 700; margin-bottom: 8px; }
    .shops-hero p { font-size: 16px; color: #d1d5db; }

    .container { max-width: 1280px; margin: 0 auto; padding: 0 24px; }

    .shops-section { padding: 32px 0 64px; }
    .shops-header {
      display: flex; justify-content: space-between; align-items: center;
      margin-bottom: 24px;
    }
    .shop-count { font-size: 15px; color: #6b7280; font-weight: 500; }

    .loading-state, .empty-state {
      text-align: center; padding: 80px 0; color: #9ca3af;
    }
    .loading-state i, .empty-state i { font-size: 48px; margin-bottom: 16px; display: block; }
    ...
    .shop-banner { height: 140px; overflow: hidden; background: #f9fafb; }
    ...
    .shop-body { padding: 20px; position: relative; }
    .shop-logo-wrapper {
    ...
    .logo-placeholder {
      width: 100%; height: 100%;
      display: flex; align-items: center; justify-content: center;
      background: #ff6b35; color: white; font-size: 24px; font-weight: 700;
    }

    .shop-name {
      margin-top: 28px; font-size: 18px; font-weight: 700; color: #1f2937;
    }
    .shop-desc {
      font-size: 14px; color: #6b7280; margin-top: 6px;
      overflow: hidden; text-overflow: ellipsis;
      display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical;
      line-height: 1.5;
    }
    .shop-desc.no-desc { font-style: italic; color: #9ca3af; }
    ...
    .meta-item .pi-star-fill { color: #f59e0b; }

    .shop-badges { display: flex; gap: 8px; margin-top: 14px; }
    .badge {
    ...
    .badge-verified i { font-size: 12px; }
    .badge-type {

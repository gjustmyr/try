...
@Component({
          ...
          <div class="profile-content">
              ...
              <div class="info-card" *ngIf="!loading">
                <div class="info-grid">
                  ...
                  <div class="info-item">
                    ...
                    <p>
                      ...
                      >
                        <i
                          [class]="
                            user?.emailVerified ? 'pi pi-check-circle' : 'pi pi-times-circle'
                          "
                        ></i>
                  ...
                  <div class="info-item">
                    ...
                    <p>
                      {{ user?.lastLogin ? (user.lastLogin | date: 'MMMM d, yyyy h:mm a') : 'N/A' }}
                    </p>
                  </div>
                </div>
              </div>
                  ...
                  <div class="address-card" *ngFor="let addr of addresses">
                    ...
                    <div class="addr-actions">
                      <button
                        ...
                        [title]="
                          addr.isDefault ? 'Cannot delete default address' : 'Delete address'
                        "
                      >
            ...
            <div class="content-section" *ngIf="activeTab === 'orders'">
              ...
              <div class="order-tabs">
                ...
                >
                  {{ tab.label }}
                  <span class="tab-count" *ngIf="getOrderCountByStatus(tab.key) > 0">{{
                    getOrderCountByStatus(tab.key)
                  }}</span>
                </button>
              </div>
                  ...
                  <div class="order-card" *ngFor="let order of filteredOrders">
                    ...
                    <div class="order-items">
                      ...
                      <div class="order-item" *ngFor="let item of order.items">
                        <div class="oi-img">
                          ...
                          <div *ngIf="!item.productImage?.url" class="oi-placeholder">
                    ...
                    <div class="order-footer">
                      ...
                      <div class="order-total">
                        Total: <strong>₱{{ order.total | number: '1.2-2' }}</strong>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div class="content-section" *ngIf="activeTab === 'security'">
              ...
              <div class="security-card">
                ...
                <div class="security-item">
                  ...
                  <button class="sec-btn" disabled><i class="pi pi-shield"></i> Enable 2FA</button>
                </div>
  ...
  styles: [
    `
      ...
      .order-tabs button.active .tab-count {

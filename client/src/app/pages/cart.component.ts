        ...
        <div class="cart-layout" *ngIf="!isLoading && cartItems.length > 0">
          <div class="cart-items">
            ...
            <div class="select-all-bar">
              ...
              <span class="selected-info" *ngIf="selectedCount > 0"
            ...
            <div class="cart-item" *ngFor="let item of cartItems" [class.selected]="item.selected">
              <label class="item-checkbox">
                ...
                <span class="custom-checkbox" [class.checked]="item.selected"
                  ><i class="pi pi-check" *ngIf="item.selected"></i
                ></span>
              </label>
              ...
              <div class="item-details">
                <div class="item-top">
                  <div>
                    <h4 class="item-name" (click)="goToProduct(item.product.id)">
                      {{ item.product.name }}
                    </h4>
                    <p
                      class="item-seller"
                      *ngIf="item.product.seller"
                      (click)="goToShop(item.product.seller.id)"
                    >
                ...
                <div class="item-bottom">
                  ...
                  <div class="item-price">
                    ...
                    <span class="unit-price" *ngIf="item.quantity > 1"
                      >₱{{ item.product.price | number: '1.2-2' }} each</span
                    >
                  </div>
                </div>
              </div>

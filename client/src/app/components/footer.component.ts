...
@Component({
      ...
      <div class="container">
        <div class="footer-content">
          <div class="footer-section">
            ...
            <p>Your trusted multi-vendor marketplace connecting buyers with quality sellers worldwide.</p>
          ...
          <div class="footer-section">
            <h4>For Sellers</h4>
            <ul>
              <li routerLink="/seller-register"><i class="pi pi-angle-right"></i> Sell on Platform</li>
  ...
  styles: [`
    .footer {
      background: #f9fafb; color: #6b7280; padding: 64px 0 32px;
    ...
    .footer-section h4 {
      font-size: 16px; margin-bottom: 16px; font-weight: 600; color: #1f2937;
    }
    .footer-section p {
      color: #6b7280; line-height: 1.6; margin-bottom: 16px; font-size: 14px;
    }
    ...
    .social-links a:hover { background: #ff6b35; color: white; }
    .footer-section ul { list-style: none; padding: 0; margin: 0; }
    .footer-section li {
      color: #6b7280; margin-bottom: 10px; cursor: pointer; transition: color 0.2s;
      display: flex; align-items: center; gap: 6px; font-size: 14px;
    }
    .footer-section li:hover { color: #ff6b35; }
    .footer-bottom {
      display: flex; justify-content: space-between; align-items: center;
      padding-top: 24px; border-top: 1px solid #e5e7eb; color: #6b7280; font-size: 13px;
    }
    .footer-bottom p { margin: 0; }
    .payment-methods { display: flex; gap: 12px; font-size: 20px; color: #6b7280; }

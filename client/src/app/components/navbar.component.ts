          ...
          <div class="search-bar">
            <div class="search-wrapper">
              ...
              <div
                ...
                *ngIf="showSearchDropdown && (searchProducts.length > 0 || searchShops.length > 0)"
              >
                <div class="search-section" *ngIf="searchShops.length > 0">
                  <div class="search-section-title"><i class="pi pi-shop"></i> Stores</div>
                  <div
                    class="search-item shop-item"
                    *ngFor="let shop of searchShops"
                    (mousedown)="goToShop(shop.id)"
                  >
                    <img
                      *ngIf="shop.shopLogo?.url"
                      [src]="shop.shopLogo.url"
                      class="search-shop-logo"
                    />
                    <div *ngIf="!shop.shopLogo?.url" class="search-shop-logo-placeholder">
                ...
                <div class="search-section" *ngIf="searchProducts.length > 0">
                  ...
                  >
                    ...
                    />
                    <div *ngIf="!product.images?.length" class="search-product-img-placeholder">
                    ...
                    <div class="search-item-info">
                      ...
                      <div class="search-item-meta">
                        ...
                        }}<span *ngIf="product.seller"> · {{ product.seller.shopName }}</span>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div class="header-actions">
            ...
            <div class="profile-wrapper" *ngIf="currentUser">
              ...
              <div class="profile-dropdown" *ngIf="showProfileDropdown">
                ...
                <button
                  class="dropdown-item"
                  *ngIf="currentUser.userType === 'seller'"
                  (click)="navigate('/seller/dashboard')"
                >

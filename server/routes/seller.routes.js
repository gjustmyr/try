...
router.put("/profile/:sellerId", authenticate, sellerController.updateSellerProfile);

// Dashboard stats (requires auth)
router.get("/dashboard/stats", authenticate, sellerController.getDashboardStats);
